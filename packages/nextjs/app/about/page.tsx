  ...
  return (
    <div className="container mx-auto p-8  ">
      ...
      <motion.p className="text-xl leading-relaxed mb-6" whileHover={{ scale: 1.02 }}>
        We leverage the power of blockchain technology to redefine property transactions. Our platform allows you to
        buy, sell, and rent real estate effortlessly
      </motion.p>
      ...
      <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8" whileHover={{ scale: 1.02 }}>
        ...
        <motion.p className="text-xl leading-loose">
          ...
          you're a seasoned investor or a first-time homebuyer, [Your Company Name] makes real estate accessible to
          everyone.
        </motion.p>
      </motion.div>
      ...
      <motion.p className="text-xl leading-loose mb-20" whileHover={{ scale: 1.02 }}>
        <motion.span className="font-bold" whileHover={{ textDecoration: "underline" }}>
          Renters/Buyers:
        </motion.span>{" "}
        We understand that finding the perfect rental is more than a search; it's a journey toward your ideal home. At
        OpenEstate, we've crafted a user-friendly platform that simplifies the rental process. Simply select any home
        you like and rent/buy it! We even offer tokens of estate for those who don't have a big budget. There's
      ...
      <motion.p className="text-xl leading-loose mb-20" whileHover={{ scale: 1.02 }}>
        ...
        If you're considering selling your property, you're in the right place. We empower sellers with a streamlined
        and transparent selling experience. All you need to do is upload your property documents and details on the
        website and relax. Via secure smart contracts, the payments will be delivered directly into your wallet!
      </motion.p>
      ...
      <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8" whileHover={{ scale: 1.02 }}>
        ...
        <motion.img src="/images/team-image.jpg" alt="Team Photo" className="rounded-md object-cover w-full h-full" />
      </motion.div>

      <motion.p className="text-xl leading-loose mb-6" whileHover={{ scale: 1.02 }}>
        Whether you dream of owning a home, expanding your investment portfolio, or participating in the future of real
        estate, OpenEstate is here to guide you every step of the way. Experience the possibilities with us.
      </motion.p>

    ...
    <div className="p-9">
      <div className="horizontal-1 flex justify-between items-center w-[90vw] ">
        ...
        <div className=" w-[30vw] justify-center items-center flex flex-col ">
          ...
          />
          <NumberInput label={'Area (in Sq ft)'} value={additionalDetails.area}
            onChange={(e: any, val: any) => {
              setAdditionalDetails((prev: any) => ({ ...prev, area: val }))
            }}
          />
          <NumberInput label={'Number of Bathrooms'} value={additionalDetails.noOfBathrooms}
            onChange={(e: any, val: any) => {
              setAdditionalDetails((prev: any) => ({ ...prev, noOfBathrooms: val }))
            }}
          />
          <NumberInput label={'Number of Bedrooms'} value={additionalDetails.noOfBedrooms}
            onChange={(e: any, val: any) => {
      ...
      <div className="horizontal-2 w-[90vw] ">
        ...
        <textarea value={additionalDetails?.description ?? ''} onChange={(e) => { setAdditionalDetails((prev: any) => ({ ...prev, description: e.target.value })) }} className="textarea rounded-3xl textarea-bordered w-full" placeholder="Short Description" />
      </div>
      ...
      <div className="horizontal-3 w-[90vw]">
        ...
        <Radio label={'BHK type'} options={['1 BHk', '2 BHK', "3BHK", "3+ BHK"]} onChange={handleBHKTypeChange} name="radio-group-2" />
      ...
      <div className="horizontal-2 w-[90vw] ">
        ...
        <AmenitySelector selectedAmenities={additionalDetails.amenities}

...
export default function Networth({realEstates}) {
            ...
            tooltip: {
                ...
                callbacks: {
                    label: function (context) {
                        ...
                        return [` Token ID : ${realEstates[index].tokenId}`, `Amount : ${convertWeiToEther(realEstates[index].amount)}`, `Number of Tokens : ${realEstates[index].numberOfTokens}`];
                    }
                }
            },
        },
    ...
    return (
        <div className="w-[300px] m-3  flex items-center ">
            <div className="mt-8">
                <Text>Net Worth distribution</Text>
